...
const imagens = [
  {
    ...
    descricao:
      "Imagem em 3D mostrando a sonda tocando um asteróide. " +
  ...
  },
  {
    ...
    descricao:
      "Foto de foguete na vertical no momento de seu " +
  ...
  },
  {
    ...
    descricao:
      "Animação de uma forma tridimensional um pouco ovalada " +
  ...
  },
  {
    ...
    descricao:
      "Foto do local de pouso da sonda Osiris-Rex no " +
  ...
  },
  {
    ...
    descricao:
      "Foto do asteróide Bennu com vários regolitos (pedras) " +
  ...
  },
  {
    ...
    descricao:
      "Foto do asteróide Bennu com ele retratado em " +
      "menos da metade e com baixa iluminação, mostrando sua superfície " +
      "acinzentada",
  },
];

let previous = document.querySelector("#anterior");
let next = document.querySelector("#proximo");
let slide = document.querySelector("#slide");

let imgTxt = slide.src.substring(servidorDasImagens.length);

let index = 0;
for (let i = 0; i < imagens.length; i++) {
  if (imagens[i].arquivo == imgTxt) {
    index = i;
  }
}

// event listener - #anterior
